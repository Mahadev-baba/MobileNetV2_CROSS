# ============================================================
# MobileNetV2 + ReLU6 + CrossEntropy Comparative Study (PyTorch)
...
if __name__ == '__main__':
    ...
    plt.title('Training and Validation Loss Comparison (ReLU6)', fontsize=13, fontweight='bold')
    plt.xlabel('Epochs')
    ...
    plt.title('Training and Validation Accuracy Comparison (ReLU6)', fontsize=13, fontweight='bold')
    plt.xlabel('Epochs')
